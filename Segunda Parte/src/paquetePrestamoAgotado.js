const PaquetePrestamoAgotado = function(){
    ...
    this.consumirDatos = function(){
        throw Error("El préstamo actual del cliente se encuentra agotado. No puede consumir datos de Internet")
    }

    this.consumirMinutos = function(){
        throw Error("El préstamo actual del cliente se encuentra agotado. No puede realizar llamadas")
    }
