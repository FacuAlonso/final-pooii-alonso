const PaquetePrestamoVencido = function(){
    ...
    this.descontarDatos = function(){
        throw new Error("El préstamo actual del cliente se encuentra vencido. No puede consumir datos de Internet")
    }

    this.descontarMinutos = function(){
        throw new Error("El préstamo actual del cliente se encuentra vencido. No puede realizar llamadas")
    }
